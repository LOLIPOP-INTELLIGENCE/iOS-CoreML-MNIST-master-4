...
class DrawView: UIView {
    ...
    func getViewContext() -> CGContext? {
        ...
        let bitmapInfo = CGImageAlphaInfo.first.rawValue
        
        // this is where our view pixel data will go in once we make the render call
        let context = CGContext(data: nil, width: 299, height: 299, bitsPerComponent: 32, bytesPerRow: 1196, space: colorSpace, bitmapInfo: bitmapInfo)
